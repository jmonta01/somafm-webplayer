...
angular.module('somafmPlayerApp')
  .controller('FavStationsCtrl', ['$scope', '$filter', '$state', 'StationService', 'FavoritesService', 'PlayerService',
    function ($scope, $filter, $state, StationService, FavoritesService, PlayerService) {
      ...
      $scope.removeStation = function (station) {
        FavoritesService.station.remove(station);
        $scope.getStations();
      };
      ...
      $scope.getStations = function () {
        var stationIds = FavoritesService.station.get();
        $scope.stations = [];
